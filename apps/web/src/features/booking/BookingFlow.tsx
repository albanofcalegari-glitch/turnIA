      ...
      >
        <span className="flex items-center gap-2 text-sm font-medium text-amber-800">
          ...
          {loyaltyProgram.cardSubtitle && (
            <span className="text-xs font-normal text-amber-600">— {loyaltyProgram.cardSubtitle}</span>
          )}
        </span>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-amber-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                />
                <button
