...
export function BookingFlow({ tenantSlug }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <footer className="border-t border-gray-200 py-4 text-center dark:border-gray-700">
        <p className="text-xs text-gray-400 dark:text-gray-500">
          Desarrollado por{' '}
          <a href="https://www.qngine.com.ar" target="_blank" rel="noopener noreferrer" className="font-semibold text-gray-500 hover:text-brand-600 transition-colors dark:text-gray-400 dark:hover:text-brand-400">
            Qngine
          </a>
        </p>
      </footer>
